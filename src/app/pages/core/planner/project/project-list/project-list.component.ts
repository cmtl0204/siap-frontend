...
@Component({
    ...
    imports: [TableModule, CurrencyPipe, Button, ButtonActionComponent, Tooltip, InputText, ReactiveFormsModule, IconField, InputIcon, Fluid, Paginator],
...
export class ProjectListComponent implements OnInit {
    ...
    redirectViewProject(id: string) {
        this._router.navigateByUrl(`${MY_ROUTES.corePages.planner.project.absolute}/${id}`);
    }

    redirectCreateProject() {
        this._router.navigateByUrl(`${MY_ROUTES.corePages.planner.project.form.absolute}/new`);
    }
