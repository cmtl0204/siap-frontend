...
export class ProgramListComponent implements OnInit {
    ...
    redirectViewProject(id: string) {
        this._router.navigateByUrl(`${MY_ROUTES.corePages.planner.program.absolute}/${id}`);
    }

    redirectProjectDocument(id: string) {
        this._router.navigateByUrl(`${MY_ROUTES.corePages.planner.program.document.absolute}/${id}`);
    }

    redirectCreateProject() {
        this._router.navigateByUrl(`${MY_ROUTES.corePages.planner.program.form.absolute}/new`);
    }
}
